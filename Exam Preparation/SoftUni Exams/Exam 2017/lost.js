function solve(keyword, text) {
    let decryptedMessageStart = text.indexOf(keyword) + keyword.length;
    let decryptedMessageEnd = text.lastIndexOf(keyword);
    let decryptedMessage = text.substring(decryptedMessageStart, decryptedMessageEnd);
    let north = 'north';
    let east = 'east';
    ...
    let northRegEx = /north(?!.*north)/ig;// another regex: new RegExp('[^\"]north(?!/)', 'ig');
    let eastRegEx = /east(?!.*east)/ig; //another regex: new RegExp('[^\"]east(?!/)', 'ig');
    // =================================================================================================
    ...
    //=====================================================================================================
    let northPosition = getCoordinates(northStartIndex);
    let eastPosition = getCoordinates(eastStartIndex);
